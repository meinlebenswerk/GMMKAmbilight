...
import { app, protocol, BrowserWindow, screen, ipcMain, powerSaveBlocker } from 'electron'
...
// Disallow renderer process reuse
...
ipcMain.handle('getPrimaryScreenResolution', () => {
